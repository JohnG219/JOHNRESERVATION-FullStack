  ...
  const alldates = getDatesInRange(dates[0].startDate, dates[0].endDate);
    const isAvailable = (roomNumber) => {
      ...
      const handleclick = async (e) => {
       ...
       alert("Thank you! your booking details has been sent...")
      };
    ...
    return(
        ...
        <h1>Reservation Completed</h1>
            <div className="details" id="printablediv">
              <hr className="hr2" />
             <span>
            <span className="itemKey">Booked ID:</span>
        ...
        <div className="detailItem">
          ...
          <button id="printbtn" onClick={Print} >Print</button>
              ...
              <div class="textali">
              <hr className="hr2" />
                  <span className="itemKey1">Please fill out the following form in as much detail as possible to avoid cancellation.</span>
                 <br></br>
                 <br></br> 
                  <form class="rInput1">
                  ...
                  <button id="bayag" onClick={handleclick} >Confirm</button>
              </form>
            </div>
          </div>
          ...
          <button id="btnnn1" onClick={handleClick}>LOG OUT</button>
