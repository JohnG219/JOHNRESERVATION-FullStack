...
const Featured = () => {
  const {data,loading,error} = useFetch("hotels/countByCity?cities=singapore,australia,philippines,norway,switzerland");
        ...
        {loading ? ("Loading..."
          ...
          <>
            <div className="featuredItem">
              <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/85960609.jpg?k=12f4e89050495cb84f81e37ac261d77e9db6e6f8499ce955a6048cb9a35c9bf1&o=&hp=1" alt="" className="featuredImg" />
