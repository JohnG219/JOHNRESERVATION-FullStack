  ...
  return (
    <div className="header">
        <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
            ...
            { type !== "list" &&
            <>
            <h1 className="headerTitle">Search deals on hotels, homes, and much more...</h1>
            <p className="headerDesc">Get rewarded for your travels - unlock instant savings of 10% of more with your <strong>JOHNRESERVATION</strong> account</p>
